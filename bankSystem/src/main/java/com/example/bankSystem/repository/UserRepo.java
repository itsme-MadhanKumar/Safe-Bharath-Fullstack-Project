...
public class UserRepo
{
    ...
    public boolean isCheckingtheOldMobile(String userId,String oldMobile)
    {
            ...
            PreparedStatement ps = conn.prepareStatement(query))
        {
            ...
            if(rs.next())
            {
                String storedpassword = rs.getString("mobile");
                if(storedpassword.equals(oldMobile))
                {
                    return true;
                }
            }
