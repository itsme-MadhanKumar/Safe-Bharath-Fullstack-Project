...
public class AbroadLoanRequest
{
    ...
    private String collateralDocumentsPath;
    ...
    public String getCollateralDocumentsPath() {
        return collateralDocumentsPath;
    }

    public void setCollateralDocumentsPath(String collateralDocumentsPath) {
        this.collateralDocumentsPath = collateralDocumentsPath;
    }
